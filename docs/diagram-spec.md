...
- 개념도 내 텍스트 과밀 — 기준은 **손글씨 폭**(2026-07-17 정정, 발주자 규격: 전폭 한 줄
  17~19자에서 유도): 박스 라벨 **4~6자**, small 부제 **6~8자**, d-circle 안 2단어(줄당 4자).
  박스 6개 초과 금지(d-cycle.c6 예외). ~~라벨 8자·small 12자~~는 타이핑본(MG 재조판) 기준이라 폐기.
  (표본 출처 구분: [MG]는 패턴 구조 근거로만 유효, 글자수 캐파는 손답안 규격을 따른다.)
